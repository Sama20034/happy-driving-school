...
const About = () => {
  return (
    <>
      <Helmet>
        <title>من نحن | كابتن مصر</title>
        <meta
          name="description"
          content="تعرف على منصة كابتن مصر - الحل الآمن والموثوق لحجز كباتن تدريب القيادة في مصر"
        />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center text-primary-foreground">
              ...
              <p className="text-lg md:text-xl text-background/80 leading-relaxed max-w-2xl mx-auto">
                منصة كابتن مصر اتأسست لحل مشاكل عدم الثقة والأمان في سوق تدريب القيادة. 
