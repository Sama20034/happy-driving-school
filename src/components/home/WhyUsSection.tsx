import { Shield, Target, Clock, BookOpen, Brain, Car, Route, FileCheck } from "lucide-react";
const benefits = [{
  icon: Shield,
...
const WhyUsSection = () => {
  return <section id="why-us" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">ليه تختاري تتعلمي السواقة مع أكاديمية كابتن دينا؟ </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => <div key={index} className="bg-card rounded-2xl p-6 shadow-card hover:shadow-glow transition-all duration-300 border border-border hover:border-primary/30 group">
