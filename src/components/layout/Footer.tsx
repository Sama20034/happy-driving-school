    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {/* Logo & About - Right Side */}
          <div className="text-center md:text-right order-1 md:order-3">
            <div className="mb-4 flex justify-center md:justify-end">
              <img src={logoImg} alt="كابتن مصر لتعليم القيادة" className="h-16 w-auto" />
            </div>
            <p className="text-primary-foreground/80 text-sm leading-relaxed max-w-xs mx-auto md:mr-0 md:ml-auto">
